...
dev_files = ['../data/preprocessed/trainset/search.dev.json']
test_files = ['../data/preprocessed/trainset/search.test.json']
...
def parse_args():
    ...
    path_settings.add_argument('--train_files', nargs='+', default=train_files, help='list of files that contain the preprocessed train data')
    path_settings.add_argument('--dev_files', nargs='+', default=dev_files, help='list of files that contain the preprocessed dev data')
    path_settings.add_argument('--test_files', nargs='+', default=test_files, help='list of files that contain the preprocessed test data')
