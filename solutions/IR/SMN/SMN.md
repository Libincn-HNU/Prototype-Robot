...
+ 闲聊模型一般分为生成模型和检索模型，目前关于检索模型的闲聊还停留在单轮对话中，本文提出了基于检索的**多轮**对话闲聊

### 难点

+ 难点1 : 如何明确上下文的关键信息（关键词，关键短语或关键句）
+ 难点2 : 在上下文中如何模拟多轮对话间的关系

![smn-demo-1-2019-12-18-20-1-36](https://blog-picture-bed.oss-cn-beijing.aliyuncs.com/blog/upload/smn-demo-1-2019-12-18-20-1-36)
...
# Ref
+ https://zhuanlan.zhihu.com/p/36446555